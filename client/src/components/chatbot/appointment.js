      ...
      <div>
        ...
        >
          ...
          <RadioButtonGroup name="shipSpeed" defaultSelected="not_light">
            <RadioButton
              key="1"
              value="Helsinki Hospital"
              label="Helsinki Hospital"
            />
            <RadioButton
              key="2"
              value="Haartman hospital"
              label="Haartman hospital"
            />
            <RadioButton
              key="3"
              value="Meilahti hospital"
              label="Meilahti hospital"
            />
            <RadioButton key="4" value="HUS" label="HUS" />
          </RadioButtonGroup>
        </Dialog>
      </div>
    );
